...
type SriovOperatorConfigSpec struct {
	...
	// Flag to enable the sriov-network-config-daemon to use a systemd mode instead of the regular method
	EnableSystemdMode bool `json:"enableSystemdMode,omitempty"`
}
